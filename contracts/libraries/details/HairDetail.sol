        ...
        return
            string(
                abi.encodePacked(
                    "<polygon fill='#",
                    hairsColor,
                    "' points='188.7,124.8 198.3,128.1 209,125.1 197.7,113.6'/>",
                    '<polygon opacity="0.5" points="188.7,124.8 198.3,128.1 211.7,124.2 197.7,113.6"/>',
                    "<path fill='#",
                    hairsColor,
        ...
        return
            string(
                abi.encodePacked(
                    "<path fill='#",
                    hairsColor,
                    "' stroke-miterlimit='10' d='M134.9,129.3c1-8.7,2.8-19.9,2.6-24.1c1.1,2,4.4,6.1,4.7,6.9 c2-15.1,3.9-18.6,6.6-28.2c0.1,5.2,0.4,6.1,4.6,11.9c0.1-7,4.5-17.6,8.8-24.3c0.6,3,4,8.2,5.8,10.7c2.4-7,8.6-13.4,14.5-17.9 c-0.3,3.4-0.1,6.8,0.7,10.1c4.9-5.1,7.1-8.7,15.6-15.4c-0.2,4.5,1.8,9,5.1,12c4.1-3.7,7.7-8,10.6-12.7c0.6,3.7,1.4,7.3,2.5,10.8 c2.6-4.6,7.9-8.4,12.4-11.3c1.5,3.5,1.3,11,5.9,11.7c7.1,1.1,10-3.3,11.4-10.1c2.2,6.6,4.8,12.5,9.4,17.7c4.2,0.5,5.7-5.6,4.2-9 c4.2,5.8,8.4,11.6,12.5,17.4c0.7-2.9,0.9-5.9,0.6-8.8c3.4,7.6,9.1,16.7,13.6,23.6c0-1.9,1.8-8.5,1.8-10.4 c2.6,7.3,7.7,17.9,10.3,36.6c0.2,1.1-28.9,7.9-28.5,9.4c-0.8-2.5-2.7-5.5-6.5-7.3c-12.1-5.7-34.5-8.6-53.4-2.9 c-16.3,4.8-22.6-1.6-32.4-2.4c-12.3-1-29.2-4.6-36.2,10.7C139.6,133.6,137.9,132.2,134.9,129.3z'/>",
                    '<polygon fill="#',
                    hairsColor,
                    '" points="271.4,138.3 300.2,129 300.7,131.1 271.9,139.6"/>',
                    '<polygon fill="#',
                    hairsColor,
                    '" points="141,137.3 134.3,132.1 134.1,133.3 140.9,137.9"/>',
                    crop()
                )
            );
    }
